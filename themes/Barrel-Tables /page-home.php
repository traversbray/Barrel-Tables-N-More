    ...
    <div class="container">
        <div class="content-wrapper">
            <div class="col-md-6 col-lg-6 img-col" >
                <div class="img-wrapper" style="background-image:url('http://barreltablesnmore.flywheelsites.com/wp-content/themes/Barrel-Tables%20/img/DCP_0959_0062_retouched.png');">
                </div>
            </div>
